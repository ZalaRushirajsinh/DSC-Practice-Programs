...
int main()
{
	...
	do
	{
		...
		cout<<"3. SEARCH THE DATA :"<<endl;
		cout<<"4. UPDATE THE DATA :"<<endl;
		cout<<"5. PRINT THE DATA :"<<endl;
		cout<<"6. EXIT FROM THE PROGRAMM :"<<endl;
		cin>>ch;
		switch(ch)
		{
			case 1:
			...
			case 3:
				...
				break;
			case 4:
				cout<<"ENTER WHICH POSITION YOU WANT TO SEARCH ="<<endl;
				cin>>b;
				l1.Search(b);
				break;
			case 5:
